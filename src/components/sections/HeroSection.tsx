...
const INTRO =
  '맡은 역할의 차이는 있어도 벽은 없습니다.\n그들과 나의 생각이 섞일 때\n비로소 가치있는 품질이 탄생한다고 믿습니다.'
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Container className="flex justify-between pt-16.25 max-md:flex-col max-md:gap-6 max-md:pt-[39vh]">
          ...
          <motion.p
            ...
            className="text-text-on-dark mt-[clamp(93px,11.11vw,160px)] max-w-[clamp(213px,27.78vw,402px)] text-[clamp(12px,1.11vw,16px)] leading-[1.6] font-medium whitespace-pre-line max-md:mt-0 max-md:max-w-none max-md:text-[14px] max-md:text-pretty max-md:break-keep max-md:whitespace-normal"
          >
            {INTRO}
          </motion.p>
        </Container>
